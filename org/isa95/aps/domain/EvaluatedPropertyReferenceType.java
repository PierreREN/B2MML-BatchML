...
public class EvaluatedPropertyReferenceType {
    ...
    public void setTestSpecificationID(IdentifierType testSpecificationID) {
    ...
    public void setEvaluatedPropertyID(IdentifierType evaluatedPropertyID) {
        this.evaluatedPropertyID = evaluatedPropertyID;
    }
}
