...
/**
 * <p>WorkCalendarType complex type的 Java 类。
 *
 ...
 *         &lt;element name="Entry" type="{http://www.mesa.org/xml/B2MML}WorkCalendarEntryType" maxOccurs="unbounded" minOccurs="0"/>
...
public class WorkCalendarType {
    ...
    protected List<WorkCalendarEntryType> entry;
     ...
     */
    public List<WorkCalendarEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<WorkCalendarEntryType>();
        }
        return this.entry;
    }
