...
/**
 * <p>MaterialInformationType complex type的 Java 类。
 *
 ...
 *         &lt;element name="MaterialTestSpecification" type="{http://www.mesa.org/xml/B2MML}TestSpecificationType" maxOccurs="unbounded" minOccurs="0"/>
...
public class MaterialInformationType {
    ...
    protected List<TestSpecificationType> materialTestSpecification;
    ...
    public List<TestSpecificationType> getMaterialTestSpecification() {
        if (materialTestSpecification == null) {
            materialTestSpecification = new ArrayList<TestSpecificationType>();
        }
