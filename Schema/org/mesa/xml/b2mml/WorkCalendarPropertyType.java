...
/**
 * <p>WorkCalendarPropertyType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="WorkCalendarPropertyType">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://www.mesa.org/xml/B2MML-AllExtensions}WorkCalendarProperty" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WorkCalendarPropertyType", propOrder = {
    "id",
    "description",
    "value",
    "property"
})
public class WorkCalendarPropertyType {
