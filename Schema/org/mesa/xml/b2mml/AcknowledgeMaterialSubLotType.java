...
/**
 * <p>AcknowledgeMaterialSubLotType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AcknowledgeMaterialSubLotType">
 *   &lt;complexContent>
...
@XmlType(name = "AcknowledgeMaterialSubLotType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class AcknowledgeMaterialSubLotType {
    ...
    protected AcknowledgeMaterialSubLotType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link AcknowledgeMaterialSubLotType.DataArea }
     *     
     */
    public AcknowledgeMaterialSubLotType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(AcknowledgeMaterialSubLotType.DataArea value) {
        this.dataArea = value;
    }
