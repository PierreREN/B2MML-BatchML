...
/**
 * <p>AcknowledgeWorkAlertType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AcknowledgeWorkAlertType">
 *   &lt;complexContent>
...
@XmlType(name = "AcknowledgeWorkAlertType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class AcknowledgeWorkAlertType {
    ...
    protected AcknowledgeWorkAlertType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link AcknowledgeWorkAlertType.DataArea }
     *     
     */
    public AcknowledgeWorkAlertType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(AcknowledgeWorkAlertType.DataArea value) {
        this.dataArea = value;
    }
