...
public class PersonnelSegmentSpecificationPropertyType {
    ...
    @XmlElement(name = "PersonnalSegmentSpecificationProperty")
    protected List<PersonnelSegmentSpecificationPropertyType> personnalSegmentSpecificationProperty;
    ...
    public List<PersonnelSegmentSpecificationPropertyType> getPersonnalSegmentSpecificationProperty() {
        if (personnalSegmentSpecificationProperty == null) {
            personnalSegmentSpecificationProperty = new ArrayList<PersonnelSegmentSpecificationPropertyType>();
        }
        return this.personnalSegmentSpecificationProperty;
    }
