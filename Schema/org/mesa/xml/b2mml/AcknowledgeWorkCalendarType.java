...
/**
 * <p>AcknowledgeWorkCalendarType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AcknowledgeWorkCalendarType">
 *   &lt;complexContent>
 ...
 *                   &lt;element name="WorkCalendar" type="{http://www.mesa.org/xml/B2MML}WorkCalendarType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "AcknowledgeWorkCalendarType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class AcknowledgeWorkCalendarType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected AcknowledgeWorkCalendarType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link AcknowledgeWorkCalendarType.DataArea }
     *     
     */
    public AcknowledgeWorkCalendarType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(AcknowledgeWorkCalendarType.DataArea value) {
        this.dataArea = value;
    }
    ...
    public static class DataArea {
        ...
        @XmlElement(name = "WorkCalendar", required = true)
