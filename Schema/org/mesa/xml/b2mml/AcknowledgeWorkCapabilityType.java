...
/**
 * <p>AcknowledgeWorkCapabilityType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AcknowledgeWorkCapabilityType">
 *   &lt;complexContent>
...
@XmlType(name = "AcknowledgeWorkCapabilityType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class AcknowledgeWorkCapabilityType {
    ...
    protected AcknowledgeWorkCapabilityType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link AcknowledgeWorkCapabilityType.DataArea }
     *     
     */
    public AcknowledgeWorkCapabilityType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(AcknowledgeWorkCapabilityType.DataArea value) {
        this.dataArea = value;
    }
