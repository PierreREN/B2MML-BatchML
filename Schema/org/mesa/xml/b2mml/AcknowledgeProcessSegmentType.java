...
/**
 * <p>AcknowledgeProcessSegmentType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AcknowledgeProcessSegmentType">
 *   &lt;complexContent>
...
@XmlType(name = "AcknowledgeProcessSegmentType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class AcknowledgeProcessSegmentType {
    ...
    protected AcknowledgeProcessSegmentType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link AcknowledgeProcessSegmentType.DataArea }
     *     
     */
    public AcknowledgeProcessSegmentType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(AcknowledgeProcessSegmentType.DataArea value) {
        this.dataArea = value;
    }
