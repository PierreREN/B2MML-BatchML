...
/**
 * <p>SyncWorkAlertType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SyncWorkAlertType">
 *   &lt;complexContent>
...
@XmlType(name = "SyncWorkAlertType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class SyncWorkAlertType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected SyncWorkAlertType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link SyncWorkAlertType.DataArea }
     *     
     */
    public SyncWorkAlertType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(SyncWorkAlertType.DataArea value) {
        this.dataArea = value;
    }
