...
/**
 * <p>ProcessSegmentInformationType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ProcessSegmentInformationType">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://www.mesa.org/xml/B2MML-AllExtensions}ProcessSegmentInformation" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ProcessSegmentInformationType", propOrder = {
    "id",
    "description",
    "hierarchyScope",
    "publishedDate",
