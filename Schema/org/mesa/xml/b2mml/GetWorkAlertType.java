...
/**
 * <p>GetWorkAlertType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetWorkAlertType">
 *   &lt;complexContent>
...
@XmlType(name = "GetWorkAlertType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class GetWorkAlertType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected GetWorkAlertType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link GetWorkAlertType.DataArea }
     *     
     */
    public GetWorkAlertType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(GetWorkAlertType.DataArea value) {
        this.dataArea = value;
    }
