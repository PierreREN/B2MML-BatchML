...
/**
 * <p>ProcessPhysicalAssetType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ProcessPhysicalAssetType">
 *   &lt;complexContent>
...
@XmlType(name = "ProcessPhysicalAssetType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class ProcessPhysicalAssetType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected ProcessPhysicalAssetType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link ProcessPhysicalAssetType.DataArea }
     *     
     */
    public ProcessPhysicalAssetType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(ProcessPhysicalAssetType.DataArea value) {
        this.dataArea = value;
    }
