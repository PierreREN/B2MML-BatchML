...
/**
 * <p>RespondMaterialSubLotType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RespondMaterialSubLotType">
 *   &lt;complexContent>
 ...
 *                   &lt;element name="MaterialSubLot" type="{http://www.mesa.org/xml/B2MML}MaterialSubLotType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "RespondMaterialSubLotType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class RespondMaterialSubLotType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected RespondMaterialSubLotType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link RespondMaterialSubLotType.DataArea }
     *     
     */
    public RespondMaterialSubLotType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(RespondMaterialSubLotType.DataArea value) {
        this.dataArea = value;
    }
    ...
    public static class DataArea {
        ...
        @XmlElement(name = "MaterialSubLot", required = true)
