...
/**
 * <p>GetPersonType complex type的 Java 类。
 * 
...
@XmlType(name = "GetPersonType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class GetPersonType {
    ...
    protected GetPersonType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link GetPersonType.DataArea }
     *     
     */
    public GetPersonType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(GetPersonType.DataArea value) {
        this.dataArea = value;
    }
