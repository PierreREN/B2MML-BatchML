...
/**
 * <p>ShowWorkAlertType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ShowWorkAlertType">
 *   &lt;complexContent>
...
@XmlType(name = "ShowWorkAlertType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class ShowWorkAlertType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected ShowWorkAlertType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link ShowWorkAlertType.DataArea }
     *     
     */
    public ShowWorkAlertType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(ShowWorkAlertType.DataArea value) {
        this.dataArea = value;
    }
