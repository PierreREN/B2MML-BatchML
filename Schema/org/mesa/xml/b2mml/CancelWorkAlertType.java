...
/**
 * <p>CancelWorkAlertType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CancelWorkAlertType">
 *   &lt;complexContent>
...
@XmlType(name = "CancelWorkAlertType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class CancelWorkAlertType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected CancelWorkAlertType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link CancelWorkAlertType.DataArea }
     *     
     */
    public CancelWorkAlertType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(CancelWorkAlertType.DataArea value) {
        this.dataArea = value;
    }
