...
/**
 * <p>ChangeWorkAlertType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ChangeWorkAlertType">
 *   &lt;complexContent>
...
@XmlType(name = "ChangeWorkAlertType", propOrder = {
    "applicationArea",
    "dataArea"
})
public class ChangeWorkAlertType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected ChangeWorkAlertType.DataArea dataArea;
     ...
     * @return
     *     possible object is
     *     {@link ChangeWorkAlertType.DataArea }
     *     
     */
    public ChangeWorkAlertType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *     
     */
    public void setDataArea(ChangeWorkAlertType.DataArea value) {
        this.dataArea = value;
    }
