...
/**
 * <p>OpMaterialActualPropertyType complex type的 Java 类。
 *
 ...
 *         &lt;group ref="{http://www.mesa.org/xml/B2MML-AllExtensions}OpMaterialActualProperty" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OpMaterialActualPropertyType {
    ...
    protected List<isa95.aps.interfaces.b2mml.operationsschedule.OpMaterialActualPropertyType> materialActualProperty;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link isa95.aps.interfaces.b2mml.operationsschedule.OpMaterialActualPropertyType }
     */
    public List<isa95.aps.interfaces.b2mml.operationsschedule.OpMaterialActualPropertyType> getMaterialActualProperty() {
        if (materialActualProperty == null) {
            materialActualProperty = new ArrayList<isa95.aps.interfaces.b2mml.operationsschedule.OpMaterialActualPropertyType>();
        }
