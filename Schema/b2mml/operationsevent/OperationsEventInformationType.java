...
/**
 * <p>OperationsEventInformationType complex type的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 *
 * <pre>
 * &lt;complexType name="OperationsEventInformationType">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://www.mesa.org/xml/B2MML-AllExtensions}OperationsEventInformation" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OperationsEventInformationType", propOrder = {
        "id",
        "description",
        "hierarchyScope",
        "publishedDate",
...
public class OperationsEventInformationType {
    ...
    @XmlElement(name = "OperationsEventClass", nillable = true)
    protected List<OperationsEventClassType> operationsEventClass;
    @XmlElement(name = "OperationsEventDefinition", nillable = true)
    protected List<OperationsEventDefinitionType> operationsEventDefinition;
    @XmlElement(name = "OperationsEvent", nillable = true)
