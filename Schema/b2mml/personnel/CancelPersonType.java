...
/**
 * <p>CancelPersonType complex type的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 *
 * <pre>
 * &lt;complexType name="CancelPersonType">
 *   &lt;complexContent>
 ...
 *                   &lt;element name="Person" type="{http://www.mesa.org/xml/B2MML}PersonType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "CancelPersonType", propOrder = {
        "applicationArea",
        "dataArea"
})
public class CancelPersonType {

    @XmlElement(name = "ApplicationArea", required = true)
    protected TransApplicationAreaType applicationArea;
    @XmlElement(name = "DataArea", required = true)
    protected CancelPersonType.DataArea dataArea;
     ...
     *
     * @return possible object is
     * {@link CancelPersonType.DataArea }
     */
    public CancelPersonType.DataArea getDataArea() {
        return dataArea;
    }
     ...
     *              {@link CancelPersonType.DataArea }
     */
    public void setDataArea(CancelPersonType.DataArea value) {
        this.dataArea = value;
    }
