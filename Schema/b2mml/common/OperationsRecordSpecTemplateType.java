...
public class OperationsRecordSpecTemplateType {
    ...
    private List<IdentifierType> informationObjectType;
    @XmlElement(name = "InformationObjectTypeMultiplicity")
    private List<TextType> informationObjectTypeMultiplicity;
    @XmlElement(name = "Action")
    private List<IdentifierType> action;
    @XmlElement(name = "ActionMultiplicity")
    private List<TextType> actionMultiplicity;
