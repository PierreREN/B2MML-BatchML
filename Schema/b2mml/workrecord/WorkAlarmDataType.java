...
/**
 * <p>WorkAlarmDataType complex type的 Java 类。
 *
 * <p>以下模式片段指定包含在此类中的预期内容。
 *
 * <pre>
 * &lt;complexType name="WorkAlarmDataType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="PriorityType" type="{http://www.mesa.org/xml/B2MML}IdentifierType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WorkAlarmDataType", propOrder = {
        "alarmEvent",
        "alarmType",
        "alarmLimit",
        "priority"
})
public class WorkAlarmDataType {
